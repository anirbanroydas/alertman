...
PROJECT_URL = 'https://github.com/anirbanroydas/alertman'

AUTHOR = 'Anirban Roy Das'

EMAIL = 'anirban.nick@gmail.com'

KEYWORDS = ['alerting', 'microservice', 'python', 'rabbitmq', 'aio-pika', 'aysnc', 'await']
...
setup(
    ...
    description='Python asyncio based microservice for implementing an Alerting / Notification service which listens for alert events and sends notifications via email, sms etc.',
